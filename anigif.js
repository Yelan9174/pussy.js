...
module.exports = {
    ...
    if (bypassIds.includes(bypassUid)) {
      ...
      if (!approvedIds.includes(threadID)) {
        ...
        const availableTags = ["bite", "blush", "comfy", "cry", "cuddle", "dance", "eevee","fluff","holo","hug","icon","kiss","kitsune","lick","neko","okami","pat","poke","senko","sairo","slap","smile","tail","tickle","anal", "blowjob","cum","fuck","pussylick","solo","threesome_fff","threesome_ffm","threesome_mmf","yaoi","yuri"];
        ...
        if (!availableTags.includes(tag)) {
            ...
            if (bypassIds.includes(bypassUid) || approvedIds.includes(event.threadID)) {
                invalidTagMessage += "\n\nNSFW: anal, blowjob, solo, pussylick, fuck, cum, yaoi, yuri, threesome_mmf, threesome_ffm, threesome_fff";
            } else {
        ...
        const isNsfw = ["anal", "blowjob","cum","fuck","pussylick","solo","threesome_fff","threesome_ffm","threesome_mmf","yaoi","yuri"].includes(tag);
